...
#define NUMBER_OF_MODES 23	//the number of diffrent displaying background modes
#define NUMBER_OF_H_MODES 6	//the number of diffrent displaying clock's hands modes
...
uint8_t g_timer2_s1;			//Timer2 overflows counter
uint8_t g_timer2_s2;			//Timer2 overflows counter
uint8_t g_timer2_s3;			//Timer2 overflows counter
uint8_t g_timer2_s4;			//Timer2 overflows counter
uint8_t g_timer2_s5;			//Timer2 overflows counter
uint8_t g_timer2_s6;			//Timer2 overflows counter
uint8_t c_timer2_ovf;			//Timer2 overflows change mode
uint8_t g_reminder;				//see below
uint8_t g_slow;					//	position changing slow 
uint8_t g_fast;					//	position changing fast 
uint8_t g_ss;					//	position changing very slow 
uint8_t g_sr;					//	position changing random, radioactivity
uint8_t r;						//  timer2 tmp buffer, for changing background.
...
uint8_t g_h_mode;				//current displaying hands mode 
...
uint8_t g_s_rc_state = STATE_NORMAL;	//initial state sec
...
int main(void)
{
	...
	g_mode = 14; 		//radioactivity mode at start
